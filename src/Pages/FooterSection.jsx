  ...
  return (
    ...
    <div className="bg-[#EBEBEB] p-14 rounded-3xl">
      ...
      <div className="col-span-1 bg-[#0065FB] rounded-3xl shadow-lg overflow-hidden ">
        ...
        <div className="col-span-2 bg-white rounded-3xl shadow-lg overflow-hidden">
            <div className='bg-[#0065FB] w-[250px] flex items-center justify-center p-4 rounded-3xl m-8'>
                <img src={dflogo} alt="" />
            </div>
          
          <div className="flex gap-6 px-10 pt-14">
            <a href="#" className="text-black hover:text-gray-900 text-xl">Services</a>
            <a href="#" className="text-black hover:text-gray-900 text-xl">Pricing</a>
            <a href="#" className="text-black hover:text-gray-900 text-xl">Collaborations</a>
          </div>
          <div className="flex gap-6 px-10 pt-3">
            <a href="#" className="text-black hover:text-gray-900 text-xl">About</a>
            <a href="#" className="text-black hover:text-gray-900 text-xl">Contact</a>
            <a href="#" className="text-black hover:text-gray-900 text-xl">Testimonials</a>
          </div>
          ...
          <a href="#" className="hover:underline text-black text-bold">Terms</a>
          <a href="#" className="hover:underline text-black text-bold">Privacy</a>
          </div>
